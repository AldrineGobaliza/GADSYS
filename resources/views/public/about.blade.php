...
<div class="text-center mb-3">
    <h2 class="text-center mb-6 fw-bold">About GAD</h2>
    <p class="text-center fs-5 mb-4">
        The "LAYAG" Gender and Development (GAD) GAD of the Leyte Normal University (LNU), and hereinafter be referred to as the LAYAG LNU GAD
...
<div class="gad-services position-relative py-5">
    <h3 class="text-center mb-4 fw-bold">Our Services</h3>
    <p class="text-center fs-5 mb-4">
...
<div class="container py-5">
    <h3 class="text-center mb-6 fw-bold">GAD Personnel</h3>
    <p class="text-center fs-5 mb-4">
